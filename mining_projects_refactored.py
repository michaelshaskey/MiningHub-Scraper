...
class MiningProjectsProcessor:
    ...
    def fetch_country_data(self, country: str) -> List[Dict]:
        ...
        payload = {
            ...
            "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ2IjoiMSIsInVzZXJfaWQiOjM4OTIsImlzX2FkbWluIjowLCJwbGFuX25hbWUiOiJmcmVlIiwiZmlyc3RfbmFtZSI6IkppbSIsImxhc3RfbmFtZSI6IlJld2VoIiwiZW1haWwiOiJqaXJld2VoOTQ4QGlhbXRpbGUuY29tIiwiaWF0IjoxNzU1NjU4NjIwLCJleHAiOjE3ODcxOTQ2MjB9.uM8k6u_ZHSUAHJ-S67AKPLrJE39HkRN0NZdd-URfN3k"
        }
    ...
    def _scrape_missing_projects(self):
        ...
        try:
            print(f"\n🔍 Starting parallel scraping of missing projects...")
            
            # Import the parallel scraper
            from project_scraper_parallel_compact import ParallelProjectScraper
            
            # Initialize scraper with configuration
            max_workers = self.config.get("SCRAPER_WORKERS", 3)
            ...
            scraper = ParallelProjectScraper(
                ...
                test_mode=self.config.get("_TEST_MODE_ACTIVE", False)
            )
            
            # Run the scraper
            output_file = scraper.scrape_missing_projects(max_projects=max_projects)
            ...
            if output_file:
                ...
                print(f"⚠️  No missing projects were scraped")
